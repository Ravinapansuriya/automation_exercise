...
Feature: As a user,
  ...
  Scenario: User should register successfully
    ...
    And I fill all details in signup page "Mrs" "Ravina@123" "21" "March" "1995" "Ravina" "Pansuriya" "Vrajbhumi" "vraj" "India" "Gujarat" "Surat" "395006" "9879796754"
    ...
    Then I should see the text "Logged in as " "Ravina"
  ...
  Scenario: User should see error message while register with existing email
    ...
    And I send email "ravina@gmail.com" to email field in signup
...
#  Test Case 14: Place Order: Register while Checkout
  Scenario: User should place the order : Register while checkout
    ...
    And I enter payment details "Ravina Pansuriya" "429333322220000" "311" "08" and "2025"
